...
#define __REFLECT_BODY_MACRO_COMBINE_INNER(A, B, C, D) A##B##C##D
#define __REFLECT_BODY_MACRO_COMBINE(A, B, C, D) __REFLECT_BODY_MACRO_COMBINE_INNER(A, B, C, D)

#define REFLECT_GENERATED_BODY(...) __REFLECT_BODY_MACRO_COMBINE(CURRENT_FILE_ID, _, __LINE__, _GENERATED_BODY);
