...
namespace Reflect
{
	...
	std::string_view Enum::ToString(ConstantType v) const
	{
	...
	const Enum::ConstantType& Enum::Parse(std::string_view v) const
	{
	...
	std::string_view EnumConstant::GetPropertyValue(std::string_view flag) const
	{
	...
	std::string_view Enum::GetPropertyValue(std::string_view flag) const
	{
